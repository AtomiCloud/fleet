  ...
  jq -n \
    ...
    '{
      ...
      deviations: [
        ...
        "the literal 15m clock is strengthened with a separate SIT-only canary-sitsoak project whose soak is 90s and which omits unrelated pichu; isolating the requested pikachu+raichu set avoids the Kargo v1.9.10 exact-set bug when extra verified Stages exist, and this fixture is never a product render"
      ],
      feasibility: {
